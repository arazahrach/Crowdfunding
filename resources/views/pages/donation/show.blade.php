          ...
          <div class="mt-3 rounded-2xl border border-slate-200 p-4">
            ...
            <div class="mt-4 flex rounded-xl bg-slate-100 p-1">
              <a href="{{ route('donation.show', $slug) }}"
                 class="flex-1 text-center text-sm font-semibold rounded-lg py-2 bg-teal-700 text-white">Deskripsi</a>
              <a href="{{ route('donation.updates', $slug) }}"
                 class="flex-1 text-center text-sm font-semibold rounded-lg py-2 text-slate-700 hover:bg-white">Update</a>
            </div>
