...
<section class="max-w-5xl mx-auto">
    ...
    <div class="mt-8 rounded-3xl bg-gradient-to-r from-teal-700 to-teal-600 text-white p-8 md:p-10">
...
{{-- NOTES (NANTI BISA DINAMIS) --}}
{{--
Nanti bisa ambil konten dari DB / CMS:
- about_title, about_desc, visi, misi, values
--}}
@endsection
